                ...
                <div className="bg-gray-800" >
                    ...
                    <div className="container flex items-center justify-center p-4 ">
                        <div className="relative">
                            ...
                            <div className="absolute pl-6 top-2 right-2"> <button onClick={props.search} className="w-20 h-10 text-white bg-red-500 rounded-lg hover:bg-red-600">Search</button> </div>
                        </div>
                    </div>
                    </form>
                </div>
